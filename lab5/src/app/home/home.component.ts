...
export class HomeComponent {
  ...
  constructor(private router:Router , private  product_servie:ApiService,private cartService:CartService){}
  products :any
  ...
  ngOnInit(){
  this.product_servie.getAllProduct().subscribe((res)=>this.products = res.products)

}
  HandleDetailes(id:any){
    this.router.navigate(['/details',id])
  }
